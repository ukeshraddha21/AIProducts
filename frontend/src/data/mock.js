// Mock data for Shraddha Uke's Portfolio
...
export const personalInfo = {
  ...
  summary: "12 years of overall experience including 6+ years in QA leadership and Agile delivery. Currently transitioning into a full-fledged Product Owner role after years of shaping business requirements, prioritizing backlogs, and aligning cross-functional teams to strategic goals.",
...
export const skills = [
  {
    ...
    skills: [
      { name: "Backlog Management", level: "Expert", icon: "📋" },
      { name: "User Story Mapping", level: "Expert", icon: "🗺️" },
      { name: "Stakeholder Collaboration", level: "Expert", icon: "🤝" },
      { name: "MVP Strategy", level: "Expert", icon: "🎯" }
    ]
  },
  {
    category: "Agile & Scrum",
    skills: [
      { name: "Sprint Planning", level: "Expert", icon: "⚡" },
      { name: "Agile Facilitation", level: "Expert", icon: "🔄" },
      { name: "Scrum Events", level: "Expert", icon: "📅" },
      { name: "Agile Coaching", level: "Expert", icon: "👥" }
    ]
  },
  {
    category: "Technical Tools",
    skills: [
      { name: "JIRA", level: "Advanced", icon: "🔧" },
      { name: "Confluence", level: "Advanced", icon: "📖" },
  ...
  },
  {
    ...
    skills: [
      { name: "Data-Driven Decisions", level: "Advanced", icon: "📊" },
      { name: "AI-Powered Insights", level: "Intermediate", icon: "🤖" },
      { name: "Product Analytics", level: "Advanced", icon: "📈" },
      { name: "Process Optimization", level: "Expert", icon: "⚙️" }
    ]
  }
];
